      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header">
                <img src={{ session('photo') }} class="img-circle elevation-2" alt="Administrator">
            ...
            <li class="user-footer">
                ...
                id="admin_profile" class="btn btn-default btn-flat">
                Profile</a> --}}
                ...
                <a href="/blood-reserve/public/logout" class="btn btn-default btn-flat float-right">Log out</a>
