...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="images/blood-reserve-logo.png" alt="Blood Reserve Logo" height="180" width="180">
  </div>
                    ...
                    <table id="example2" class="table table-bordered table-striped" >
                        ...
                        <tbody>
                            ...
                            @foreach ($municipalities as $municipality)
                              <tr>
                                <td><img src="{{ asset('images/municipalities/' . $municipality['logo']) }}" style="width:80px;height:80px;" alt="Municipality Logo"></td>
                              ...
                              ?>
                                ...
                                <td>
                                  ...
                                  <button type="button" class="btn btn-success btn-sm edit" data-id="{{$municipality['id']}}" 
                                  data-name="{{$municipality['name']}}" data-latitude="{{$municipality['latitude']}}" 
                                  data-longitude="{{$municipality['longitude']}}" data-status="{{$municipality['status']}}" 
                                  ><i class="fas fa-edit"></i> Edit</button>

                                  
													        <button type="button" class="btn btn-danger btn-sm delete" data-id="{{$municipality['id']}}" 
